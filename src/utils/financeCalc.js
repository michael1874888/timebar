...
// ES Module exports (for Vite/React)
const TimeBarFinance = (typeof module === 'object' && module.exports)
  ? module.exports
  : (typeof self !== 'undefined' ? self.TimeBarFinance : {});

export const { CONSTANTS, FinanceCalc, Formatters, GPSCalc } = TimeBarFinance;
